...
export const DEFAULT_EDITOR_SETTINGS: EditorSettings = {
  ...
  itemPresets: [
    { id: uuidv4(), name: 'Small Carton', length: 30, width: 30, height: 30, unit: 'cm', price: 0.500 },
    { id: uuidv4(), name: 'Medium Carton', length: 45, width: 45, height: 45, unit: 'cm', price: 1.000 },
    { id: uuidv4(), name: 'Large Carton', length: 60, width: 60, height: 60, unit: 'cm', price: 1.500 },
    { id: uuidv4(), name: 'Sofa (3-Seater)', length: 200, width: 90, height: 80, unit: 'cm', price: 10.000 },
    { id: uuidv4(), name: 'Queen Bed', length: 200, width: 150, height: 100, unit: 'cm', price: 8.000 },
    { id: uuidv4(), name: 'Wardrobe', length: 180, width: 60, height: 200, unit: 'cm', price: 12.000 },
    { id: uuidv4(), name: 'Refrigerator', length: 80, width: 80, height: 180, unit: 'cm', price: 5.000 },
    { id: uuidv4(), name: 'Washing Machine', length: 60, width: 60, height: 85, unit: 'cm', price: 4.000 },
    { id: uuidv4(), name: 'Dining Table (6p)', length: 180, width: 90, height: 75, unit: 'cm', price: 7.000 },
    { id: uuidv4(), name: 'TV (55")', length: 125, width: 10, height: 75, unit: 'cm', price: 3.000 },
  ],
  customerFields: [
