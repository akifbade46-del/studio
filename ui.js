...
import { loadAdminData, loadDriverTasks, listenForDeliveries } from './delivery.js';
...
function openCompletionModal(delivery) {
    ...
    // Defer canvas resizing to ensure modal is visible and has dimensions
    setTimeout(resizeCanvas, 50); 
    
    // Initialize SignaturePad if it doesn't exist
    if (!completionSignaturePad) {
        import('https://cdnjs.cloudflare.com/ajax/libs/signature_pad/1.5.3/signature_pad.min.js').then(() => {
